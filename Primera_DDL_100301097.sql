...
--CREATE SCHEMA jp AUTHORIZATION DBO;
CREATE SCHEMA test AUTHORIZATION DBO;
DROP SCHEMA test;
DROP SCHEMA jp;
DROP TABLE test.ESCUELA;
DROP TABLE jp.ESCUELA;


DROP DATABASE JPDB;
CREATE DATABASE JPDB
GO
USE JPDB
-- no olvidarse nunca de seleccionar la BD de trabajo
GO
...
CREATE TABLE GUIA
(CODIGO_GUIA INT NOT NULL CONSTRAINT pk_cod_escuela PRIMARY KEY,
NOMBRE_GUIA VARCHAR(70),
APELLIDO_GUIA VARCHAR(70) 
);
CREATE TABLE RESERVA
(NUMERO_RESERVA INT NOT NULL CONSTRAINT pk_cod_escuela PRIMARY KEY,
